...
public class PagesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper.SimpleCallback(
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder,
                ...
                db.updateRef(userid, 1);
                Log.e("onSwiped", viewHolder.getAdapterPosition() + "");
                Toast.makeText(getApplicationContext(), "added to VIP", Toast.LENGTH_SHORT).show();
            ...
            @Override
            public boolean onMove(RecyclerView arg0, RecyclerView.ViewHolder arg1,
    ...
    protected void onPostResume() {
        if(feedsList != null && feedsList.size() > 0){
            adapter = new MyRecyclerAdapter(PagesActivity.this,feedsList,twitter,db);
            mRecyclerView.setAdapter(adapter);
        }
        super.onPostResume();
    }
    ...
    @Subscribe
    public void onEvent(AddToPages event){
        new AsyncHttpTask().execute();
    }
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            Integer result = 0;
            try {
                feedsList = db.getFeeds(MainActivity.pages);
                Log.e("feedP", ""+feedsList.size());
                result = 1;
            } catch (Exception e) {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (swipe.isActivated()) {
                ...
                if (result == 1) {
                    ...
                    Toast.makeText(PagesActivity.this, "Failed to fetch data!",
